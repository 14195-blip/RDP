...
async def update_companies(guild_id: str, data: CompanyUpdate, user: dict = Depends(get_current_user)):
    return await update_section(guild_id, "companies", data.companies)
...
async def update_aliases(guild_id: str, data: AliasesUpdate, user: dict = Depends(get_current_user)):
    return await update_section(guild_id, "aliases", data.aliases)
